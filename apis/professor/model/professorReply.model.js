...
class ProfessorReply {
     ...
     */
    createProfessorReply(professorReplyData) {
     ...
     */
    listProfessorReply(professorInfoIndex) {
        return new Promise((resolve, reject) => {
            pool.getConnection(function (err, connection) {
     ...
     * @returns {Promise<any>}
     */
    pageListProfessorReply(professorInfoIndex, page, count) {
        return new Promise((resolve, reject) => {
            pool.getConnection(function (err, connection) {
     ...
     * @returns {Promise<any>}
     */
    myProfessorReplyPostList(userIndex) {
        return new Promise((resolve, reject) => {
            pool.getConnection(function (err, connection) {
                connection.query(`SELECT
				 t1.professorReplyIndex,
     ...
     */
    getProfessorReply(professorReplyIndex) {
        return new Promise((resolve, reject) => {
            pool.getConnection(function (err, connection) {
                connection.query(`SELECT 
     ...
     */
    getProfessorReplyByUserIndex(professorInfoIndex, userIndex) {
        return new Promise((resolve, reject) => {
            pool.getConnection(function (err, connection) {
                connection.query(`SELECT
					 professorInfoIndex,
     ...
     * @returns {Promise<IProfessorReply>}
     */
    updateProfessorReply(professorReplyIndex, professorReplyData) {
        return new Promise((resolve, reject) => {
            pool.getConnection(function (err, connection) {
     ...
     * @returns {Promise<any>}
     */
    averageProfessorReply(professorInfoIndex) {
        return new Promise((resolve, reject) => {
            pool.getConnection(function (err, connection) {
                connection.query(`SELECT 
     ...
     * @returns {Promise<IProfessorReply>}
     */
    deleteProfessorReply(professorReplyIndex) {
        return new Promise((resolve, reject) => {
            pool.getConnection(function (err, connection) {
...
exports.ProfessorReply = ProfessorReply;
exports.professorReply = new ProfessorReply();
//# sourceMappingURL=professorReply.model.js.map