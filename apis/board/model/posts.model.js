...
class Posts {
    ...
    listPosts(filter) {
      ...
      INNER JOIN user AS t2 ON t1.userIndex = t2.userIndex
            ...
            if (filter) {
                const resultFilter = yield this.filterPosts(filter);
     ...
     * @param count
     */
    pageListPosts(filter, orderBy, page, count) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let sortType;
      ...
      INNER JOIN user AS t2 ON t1.userIndex = t2.userIndex
            ...
            if (orderBy) {
                const orderByObj = yield this.orderByPosts(orderBy);
     ...
     * @param filter
     */
    listPostsByIsScrap(userIndex, filter) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let sql = `SELECT 
			t1.postsIndex,
			t1.userIndex,
     ...
     * @param count
     */
    pageListPostsByIsScrap(userIndex, filter, orderBy, page, count) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let sortType;
            let start = (page - 1) * count;
            if (start < 0) {
     ...
     * @param filter
     */
    listPostsByUserIndex(userIndex, filter) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let sql = `SELECT 
			t1.postsIndex,
			t1.userIndex,
     ...
     * @param count
     */
    pageListPostsByUserIndex(userIndex, filter, orderBy, page, count) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let sortType;
            let start = (page - 1) * count;
            if (start < 0) {
     ...
     * @returns {Promise<void>}
     */
    getPostsIncludeUserIndex(postsIndex) {
        return new Promise((resolve, reject) => {
            pool.getConnection((err, connection) => {
                connection.query(`SELECT 
				t1.postsIndex,
     ...
     * @returns {Promise<void>}
     */
    updatePostsStatus(postsIndex, status) {
        return new Promise((resolve, reject) => {
            pool.getConnection((err, connection) => {
     ...
     * @returns {Promise<void>}
     */
    updatePosts(postsIndex, postsData) {
        return new Promise((resolve, reject) => {
            pool.getConnection((err, connection) => {
